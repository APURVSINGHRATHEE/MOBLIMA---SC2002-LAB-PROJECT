...
public class StaffMovieListingView {
     ...
     */
    protected ArrayList<MovieMain> movieList;
     ...
     */
    void editMovieField(Scanner sc, int updateChoice, MovieMain movie) {
            String input;
            int choice;
            float duration;
            Scanner sc3 = sc;
            ...
            case 6:
                    ...
                    ArrayList<Genre> mg = new ArrayList<>();
                    for (Genre x: EnumSet.allOf(Genre.class)) {
