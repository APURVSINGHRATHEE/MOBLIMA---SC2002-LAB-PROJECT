...
public class CineplexController extends Controller {
    ...
    /**
     * Create a new cinema (using base)
     * @param cinemaCode code of the new cinema
     * @param base base of the new cinema
     * @return the newly created cinema if successful, null otherwise
     */
    public Cinema createCinema(String cinemaCode, CinemaBase base) {
        return new Cinema(cinemaCode,base);
    }
