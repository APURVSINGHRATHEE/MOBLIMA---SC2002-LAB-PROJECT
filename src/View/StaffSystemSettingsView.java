...
import Model.KickOff.TicketType;
...
public class StaffSystemSettingsView {
    ...
    /**
     *  Reference to KickOff controller
     */
    private KickOffController stc;
    
    /**
     *  Create a Staff system setting view instance
     */
    protected StaffSystemSettingsView() {
    	holidayDates = KickOffController.getInstance().getHolidays();
    	ticketTypeList = KickOffController.getInstance().getAllTicketTypes();
        stc = KickOffController.getInstance();
    }
    ...
    public void changeHolidays(){
    	int choice;
        KickOffController stc = KickOffController.getInstance();
